...
import { TonConnectUIProvider, useTonConnectUI, useTonWallet, TonConnectButton, THEME } from '@tonconnect/ui-react';
...
import { ConnectWalletButton } from './components/TonConnectButton/TonConenctButton';
          ...
          {!isMobile && (
            <>
              ...
              <Box sx={{ display: 'flex', gap: 2, alignItems: 'center' }}>
                ...
                <TonConnectButton 
                  style={{
                    '--tc-button-border-radius': '6px',
                    '--tc-button-hover-border-radius': '8px'
